              ...
              form: z.discriminatedUnion("type", [
                z.object({
                  ...
                  strength: z.preprocess(
                    (val) => Number(val),
                    z.nativeEnum(ParacetamolTabletStrength)
                  ),
                ...
                z.object({
                  ...
                  strength: z.preprocess(
                    (val) => Number(val),
                    z.nativeEnum(ParacetamolSyrupStrength)
                  ),
            ...
            z.object({
              ...
              form: z.discriminatedUnion("type", [
                z.object({
                  ...
                  strength: z.preprocess(
                    (val) => Number(val),
                    z.nativeEnum(IbuprofenTabletStrength)
                  ),
                  dose: z.number().min(1, "Dose must be at least 1 mg"),
                }),
                z.object({
                  ...
                  strength: z.preprocess(
                    (val) => Number(val),
                    z.nativeEnum(IbuprofenCapsuleStrength)
                  ),
                  dose: z.number().min(1, "Dose must be at least 1 mg"),
                }),
                z.object({
                  ...
                  strength: z.preprocess(
                    (val) => Number(val),
                    z.nativeEnum(IbuprofenSuppositoryStrength)
                  ),
                  dose: z.number().min(1, "Dose must be at least 1 mg"),
                }),
                z.object({
                  ...
                  strength: z.preprocess(
                    (val) => Number(val),
                    z.nativeEnum(IbuprofenSuspensionStrength)
                  ),
                  dose: z.number().min(1, "Dose must be at least 1 ml"),
                }),
              ]),
